...
void collisioni_proiettili_macchine()
{
    for (size_t i = 0; i < N_VEICOLI; i++)
    {
        ...
        for (size_t l = 0; l < N_MAX_P; l++) //proiettili nemici
        {
           if (veicoli[i].id_sprite == 1 || veicoli[i].id_sprite == 4) //hitbox macchina
            {
                if( (proiettili_nemici[l].y >= veicoli[i].y && proiettili_nemici[l].y <= veicoli[i].y + (H_FROGGER -1)) && (proiettili_nemici[l].x >= veicoli[i].x && proiettili_nemici[l].x <= veicoli[i].x + 13))
                {
            ...
            {
                if( (proiettili_nemici[l].y >= veicoli[i].y && proiettili_nemici[l].y <= veicoli[i].y + (H_FROGGER -1)) && (proiettili_nemici[l].x >= veicoli[i].x && proiettili_nemici[l].x <= veicoli[i].x + 27))
                {
                    proiettili_nemici[l].x = -1;
                }
            }
